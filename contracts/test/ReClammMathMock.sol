...
contract ReClammMathMock {
    ...
    function computeDailyPriceShiftBase(uint256 doublingRateScalingFactor) external pure returns (uint256) {
        return ReClammMath.computeDailyPriceShiftBase(doublingRateScalingFactor);
    }
}
