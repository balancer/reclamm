...
contract ReClammPoolContractsDeployer is BaseContractsDeployer {
    ...
    struct DefaultDeployParams {
        ...
        uint256 defaultDoublingRateScalingFactor;
    ...
    constructor() {
        ...
        defaultParams = DefaultDeployParams({
            ...
            defaultDoublingRateScalingFactor: 100e16, // 100%
    ...
    function createReClammPool(
        ...
        newPool = ReClammPoolFactory(poolFactory).create(
            ...
            defaultParams.defaultDoublingRateScalingFactor,
        ...
        poolArgs = abi.encode(
            ReClammPoolParams({
                ...
                initialDoublingRateScalingFactor: defaultParams.defaultDoublingRateScalingFactor,
